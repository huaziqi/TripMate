  ...
  setup(__props) {
    ...
    function locateCurrentPosition() {
      ...
      common_vendor.index.getLocation({
        ...
        isHighAccuracy: true,
        success: (res) => {
          common_vendor.index.__f__("log", "at pages/map-test/map-test.vue:107", "定位结果：", res.latitude, res.longitude);
        ...
        fail: (err) => {
          common_vendor.index.__f__("log", "at pages/map-test/map-test.vue:139", "定位失败：", err);
    ...
    async function updateAddress(latitudeValue, longitudeValue) {
      try {
        ...
        common_vendor.index.__f__("log", "at pages/map-test/map-test.vue:175", "当前地址", result);
      } catch (err) {
        common_vendor.index.__f__("log", "at pages/map-test/map-test.vue:177", "地址解析失败：", err);
    ...
    return (_ctx, _cache) => {
      return {
        ...
        f: common_vendor.o(($event) => switchMapType("normal")),
        g: mapType.value === "satellite" ? 1 : "",
        h: common_vendor.o(($event) => switchMapType("satellite")),
        ...
        m: common_vendor.o(locateCurrentPosition)
      };
    };
  }
});
