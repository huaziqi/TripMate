  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return common_vendor.e({
        ...
        G: commentText.value,
        H: common_vendor.o(($event) => commentText.value = $event.detail.value, "7d"),
        I: common_vendor.t(commentText.value.length),
        J: submitting.value,
        K: common_vendor.o(submitComment, "a0"),
        L: common_vendor.o(() => {
        }, "a6")
      } : {});
    };
